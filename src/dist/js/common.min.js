...
!function(){"use strict";function t(t){return{restrict:"A",require:"?^^inViewContainer",link:function(e,u,c,l){var a={};c.inViewOptions&&(a=e.$eval(c.inViewOptions)),a.offset&&(a.offset=o(a.offset)),a.viewportOffset&&(a.viewportOffset=o(a.viewportOffset));var p=f({type:"initial"}).merge(s(window,"checkInView click ready wheel mousewheel DomMouseScroll MozMousePixelScroll resize scroll touchmove mouseup keydown"));l&&(p=p.merge(l.eventsSignal)),a.throttle&&(p=p.throttle(a.throttle));var h=p.map(function(t){var e;e=l?l.getViewportRect():n(),e=r(e,a.viewportOffset);var o=r(u[0].getBoundingClientRect(),a.offset),c={inView:i(o,e),event:t,element:u,elementRect:o,viewportRect:e};return a.generateParts&&c.inView&&(c.parts={},c.parts.top=o.top>=e.top,c.parts.left=o.left>=e.left,c.parts.bottom=o.bottom<=e.bottom,c.parts.right=o.right<=e.right),c}).scan({},function(t,e){return a.generateDirection&&e.inView&&t.elementRect&&(e.direction={horizontal:e.elementRect.left-t.elementRect.left,vertical:e.elementRect.top-t.elementRect.top}),e.changed=e.inView!==t.inView||!angular.equals(e.parts,t.parts)||!angular.equals(e.direction,t.direction),e}).filter(function(t){return!!t.changed&&!("initial"===t.event.type&&!t.inView)}),d=t(c.inView),g=h.subscribe(function(t){e.$applyAsync(function(){d(e,{$inview:t.inView,$inviewInfo:t})})});e.$on("$destroy",g)}}}function e(){return{restrict:"A",controller:["$element",function(t){this.element=t,this.eventsSignal=s(t,"scroll"),this.getViewportRect=function(){return t[0].getBoundingClientRect()}}]}}function n(){var t={top:0,left:0,width:window.innerWidth,right:window.innerWidth,height:window.innerHeight,bottom:window.innerHeight};if(t.height)return t;var e=document.compatMode;return"CSS1Compat"===e?(t.width=t.right=document.documentElement.clientWidth,t.height=t.bottom=document.documentElement.clientHeight):(t.width=t.right=document.body.clientWidth,t.height=t.bottom=document.body.clientHeight),t}function i(t,e){return!(e.left>t.right||e.right<t.left||e.top>t.bottom||e.bottom<t.top)}function o(t){return angular.isArray(t)?2==t.length?t.concat(t):3==t.length?t.concat([t[1]]):t:[t,t,t,t]}function r(t,e){if(!e)return t;var n={top:u(e[0])?parseFloat(e[0])*t.height:e[0],right:u(e[1])?parseFloat(e[1])*t.width:e[1],bottom:u(e[2])?parseFloat(e[2])*t.height:e[2],left:u(e[3])?parseFloat(e[3])*t.width:e[3]};return{top:t.top-n.top,left:t.left-n.left,bottom:t.bottom+n.bottom,right:t.right+n.right,height:t.height+n.top+n.bottom,width:t.width+n.left+n.right}}function u(t){return angular.isString(t)&&t.indexOf("%")>0}function c(t){this.didSubscribeFunc=t}function l(){var t=arguments;return new c(function(e){for(var n=[],i=t.length-1;i>=0;i--)n.push(t[i].subscribe(function(){e.apply(null,arguments)}));e.$dispose=function(){for(var t=n.length-1;t>=0;t--)n[t]&&n[t]()}})}function s(t,e){return new c(function(n){var i=function(t){n(t)},o=angular.element(t);o.on(e,i),n.$dispose=function(){o.off(e,i)}})}function f(t){return new c(function(e){setTimeout(function(){e(t)})})}var a=angular.module("angular-inview",[]).directive("inView",["$parse",t]).directive("inViewContainer",e);c.prototype.subscribe=function(t){this.didSubscribeFunc(t);var e=function(){t.$dispose&&(t.$dispose(),t.$dispose=null)};return e},c.prototype.map=function(t){var e=this;return new c(function(n){n.$dispose=e.subscribe(function(e){n(t(e))})})},c.prototype.filter=function(t){var e=this;return new c(function(n){n.$dispose=e.subscribe(function(e){t(e)&&n(e)})})},c.prototype.scan=function(t,e){var n=this;return new c(function(i){var o=t;i.$dispose=n.subscribe(function(t){o=e(o,t),i(o)})})},c.prototype.merge=function(t){return l(this,t)},c.prototype.throttle=function(t){var e,n,i=this;return new c(function(o){var r=i.subscribe(function(){var i=+new Date,r=arguments;e&&i<e+t?(clearTimeout(n),n=setTimeout(function(){e=i,o.apply(null,r)},t)):(e=i,o.apply(null,r))});o.$dispose=function(){clearTimeout(n),r&&r()}})},"function"==typeof define&&define.amd?define(["angular"],a):"undefined"!=typeof module&&module&&module.exports&&(module.exports=a)}();
...
!function(){function n(n,e){return{restrict:"A",scope:{target:"=sideMenuOpen"},link:function(n,t,i){function o(){0===n.backdrop.length&&e.find("body").append("<div class='aside-backdrop'></div>"),n.aside.addClass("in"),n.backdrop.addClass("in"),n.backdrop.on("click tap",a),e.find("[data-dismiss=aside], [data-dismiss=asidebar]").on("click tap",a)}function a(){e.find(".aside-backdrop.in").length>0&&n.backdrop.removeClass("in"),n.aside.removeClass("in")}n.aside=e.find("#"+n.target),n.backdrop=e.find(".aside-backdrop"),t.on("click tap",o)}}}var e=e||angular.module("bloomSideMenu",["matchMedia"]);e.directive("sideMenuOpen",n),n.$inject=["$log","$document"],e.directive("sticky",["$log","$document","screenSize",function(n,e,t){return{restrict:"A",link:function(n,i,o){t.rules={desktop:"(min-width: 1024px)"},e.ready(function(){function o(n,e,t){function i(){a+=1/60;var e=a/s,d=c[t](e);e<1?(requestAnimFrame(i),window.scrollTo(0,o+(n-o)*d)):(console.log("scroll done"),window.scrollTo(0,n))}var o=window.scrollY,n=n||0,e=e||2e3,t=t||"easeOutSine",a=0,s=Math.max(.1,Math.min(Math.abs(o-n)/e,.8)),c=(Math.PI/2,{easeOutSine:function(n){return Math.sin(n*(Math.PI/2))},easeInOutSine:function(n){return-.5*(Math.cos(Math.PI*n)-1)},easeInOutQuint:function(n){return(n/=.5)<1?.5*Math.pow(n,5):.5*(Math.pow(n-2,5)+2)}});i()}var a=i.offset(),s=i[0].clientHeight,c=i.parent().offset().top,d=i.parent()[0].clientHeight,r=e.find(".nav-top")[0].clientHeight;n.vh=.09*document.documentElement.clientHeight,n.desktop=t.is("desktop"),t.on("desktop",function(e){n.desktop=e,n.vh=.09*document.documentElement.clientHeight}),e.scroll(function(){var t=e.scrollTop(),o=t+s+r;if(t>a.top-r&&n.desktop){var l=o<c+d?t-a.top+r:d-s-2;i.css({marginTop:l})}else i.css({marginTop:0})});var l=e.find(".plus-bullet");l.on("click tap",function(){i.toggleClass("sticky-show")}),i.find("a").on("click tap",function(t){t.preventDefault();var a=angular.element(t.target).attr("href");o(e.find(a)[0].offsetTop+n.vh,1500),n.desktop||i.toggleClass("sticky-show")}),window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(n){window.setTimeout(n,1e3/60)}}()})}}}])}();
!function(){function e(e,l){var n=this;n.seller=!0,n.setActive=function(e){n.seller="seller"===e}}var l=l||angular.module("bloomTabs",["ngAnimate"]);l.controller("TabController",e),e.$inject=["$log","$document"]}();
!function(){function e(){return{restrict:"A",require:"ngModel",link:function(e,t,i,n){n.$parsers.unshift(function(e){return n.$setValidity("fullName",e.split(" ").length>1),e})}}}function t(){return{restrict:"A",scope:{passwordCheck:"="},require:"ngModel",link:function(e,t,i,n){n.$parsers.unshift(function(t){var i=t===e.passwordCheck;return n.$setValidity("passwordCheck",i),t})}}}function i(){return{restrict:"A",require:"ngModel",link:function(e,t,i,n){n.$parsers.unshift(function(e){var t=/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(e);return console.log(t),n.$setValidity("emailCheck",t),e})}}}var n=n||angular.module("bloomValidate",["ngAnimate","ngMessages"]);n.directive("validateName",e),n.directive("passwordCheck",t),n.directive("validateEmail",i)}();
function MainController(o){}var app=app||angular.module("Bloombees",["ngCookies","ngAnimate","bloomValidate","bloomSideMenu","bloomCookies","bloomLang","bloomTabs","ngParallax","angular-inview"]);app.controller("MainController",MainController),MainController.$inject=["$log"];
$(function(){function t(t,e,a){t.addEventListener?t.addEventListener(e,function(t){a(t,t.target)},!1):t.attachEvent&&t.attachEvent("on"+e,function(t){a(t,t.srcElement)})}function e(t){return!(t.getAttribute("readonly")||t.readonly)&&!(t.getAttribute("disabled")||t.disabled)&&(t.getAttribute("pattern")||t.getAttribute("required"))}function a(t){if(e(t)){var a=t.getAttribute("required")&&!t.value||t.getAttribute("pattern")&&t.value&&!new RegExp(t.getAttribute("pattern")).test(t.value);!a&&t.getAttribute("aria-invalid")?t.removeAttribute("aria-invalid"):a&&!t.getAttribute("aria-invalid")&&t.setAttribute("aria-invalid","true")}}var r=$(".input-block");r.each(function(t,e){var a=$(e),i=$("label",a),n=$("input, textarea",a),l=$(".input-info",a);n.attr("disabled")&&r.addClass("disabled"),n.on("focus",function(){a.addClass("dirty")}),n.on("blur input",function(){a.removeClass("has-error"),n.attr("required")&&!n.val()?(a.addClass("has-error"),l.html("<p>This field cannot be empty</p>")):"email"===n.attr("type")&&(n.attr("aria-invalid")?(a.addClass("has-error"),l.html("<p>Invalid email format</p>")):n.val().length>255&&(a.addClass("has-error"),l.html("<p>Maximum number of characters for this field is  255</p>")))}),void 0!=n.attr("placeholder")&&i.addClass("placeholder")}),t(document,"change",function(t,e){a(e)});for(var i=[document.getElementsByTagName("input"),document.getElementsByTagName("textarea")],n=i.length,l=0;l<n;l++)for(var d=i[l].length,u=0;u<d;u++)t(i[l][u],"change",function(t,e){a(e)})});
function showLogin(){$("#loginModal").modal("show");var t=$(".input-block");t.each(function(a,e){var i=$(e),n=$("label",i),r=$("input",i),d=$(".input-info",i);r.attr("disabled")&&t.addClass("disabled"),r.on("focus",function(){i.addClass("dirty")}),r.on("blur input",function(){i.removeClass("has-error"),r.attr("required")&&!r.val()?(i.addClass("has-error"),d.html("<p>This field cannot be empty</p>")):"email"===r.attr("type")?r.attr("aria-invalid")?(i.addClass("has-error"),d.html("<p>Invalid email format</p>")):r.val().length>255&&(i.addClass("has-error"),d.html("<p>Maximum number of characters for this field is  255</p>")):"password"===r.attr("type")&&r.val().length<8&&(i.addClass("has-error"),d.html("<p>Password is too short (minimum is 8 characters)</p>"))}),void 0!=r.attr("placeholder")&&n.addClass("placeholder")})}function addEvent(t,a,e){t.addEventListener?t.addEventListener(a,function(t){e(t,t.target)},!1):t.attachEvent&&t.attachEvent("on"+a,function(t){e(t,t.srcElement)})}function shouldBeValidated(t){return!(t.getAttribute("readonly")||t.readonly)&&!(t.getAttribute("disabled")||t.disabled)&&(t.getAttribute("pattern")||t.getAttribute("required"))}function instantValidation(t){if(shouldBeValidated(t)){var a=t.getAttribute("required")&&!t.value||t.getAttribute("pattern")&&t.value&&!new RegExp(t.getAttribute("pattern")).test(t.value);!a&&t.getAttribute("aria-invalid")?t.removeAttribute("aria-invalid"):a&&!t.getAttribute("aria-invalid")&&t.setAttribute("aria-invalid","true")}}addEvent(document,"change",function(t,a){instantValidation(a)});for(var fields=[document.getElementsByTagName("input"),document.getElementsByTagName("textarea")],a=fields.length,i=0;i<a;i++)for(var b=fields[i].length,j=0;j<b;j++)addEvent(fields[i][j],"change",function(t,a){instantValidation(a)});
/*!
