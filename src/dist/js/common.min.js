...
!function(){"use strict";function e(e){var t={lg:"(min-width: 1200px)",md:"(min-width: 992px) and (max-width: 1199px)",sm:"(min-width: 768px) and (max-width: 991px)",xs:"(max-width: 767px)"};this.isRetina=window.devicePixelRatio>1||window.matchMedia&&window.matchMedia("(-webkit-min-device-pixel-ratio: 1.5),(-moz-min-device-pixel-ratio: 1.5),(min-device-pixel-ratio: 1.5),(min-resolution: 192dpi),(min-resolution: 2dppx)").matches;var i=this,n=function(t,i){i=i||e;var n=i.$root.$$phase;"$apply"===n||"$digest"===n?t&&"function"==typeof t&&t():i.$apply(t)},r=function(e){if("string"!=typeof e&&"[object Array]"!==Object.prototype.toString.call(e))throw new Error("screenSize requires array or comma-separated list");return"string"==typeof e?e.split(/\s*,\s*/):e},o=function(){var e=i.rules||t;for(var n in e)if(e.hasOwnProperty(n)&&window.matchMedia(e[n]).matches)return n};this.get=o,this.is=function(e){return e=r(e),e.indexOf(o())!==-1},this.on=function(e,t,r){function o(){n(t(i.is(e)),r)}return window.addEventListener("resize",o),r&&r.$on("$destroy",function(){window.removeEventListener("resize",o)}),i.is(e)},this.onChange=function(e,t,a){function s(){var i=d;d=o();var r=t.indexOf(i)!==-1,s=t.indexOf(d)!==-1;r!==s&&n(a(s),e)}var d=o();if(t=r(t),!e)throw"scope has to be applied for cleanup reasons. (destroy)";return window.addEventListener("resize",s),e.$on("$destroy",function(){window.removeEventListener("resize",s)}),i.is(t)},this.when=function(e,t,r){return window.addEventListener("resize",function(){i.is(e)===!0&&n(t(i.is(e)),r)}),i.is(e)}}var t=angular.module("matchMedia",[]);t.run(function(){window.matchMedia||(window.matchMedia=function(){var e=window.styleMedia||window.media;if(!e){var t=document.createElement("style"),i=document.getElementsByTagName("script")[0],n=null;t.type="text/css",t.id="matchmediajs-test",i.parentNode.insertBefore(t,i),n="getComputedStyle"in window&&window.getComputedStyle(t,null)||t.currentStyle,e={matchMedium:function(e){var i="@media "+e+"{ #matchmediajs-test { width: 1px; } }";return t.styleSheet?t.styleSheet.cssText=i:t.textContent=i,"1px"===n.width}}}return function(t){return{matches:e.matchMedium(t||"all"),media:t||"all"}}}())}),t.service("screenSize",e),e.$inject=["$rootScope"],t.filter("media",["screenSize",function(e){var t=function(t,i){var n=e.get(),r="";if(!i)return n;if(i.groups){for(var o in i.groups)if(i.groups.hasOwnProperty(o)){var a=i.groups[o].indexOf(n);a>=0&&(r=o)}""===r&&(r=n)}return i.replace&&"string"==typeof i.replace&&i.replace.length>0?t.replace(i.replace,r):r};return t.$stateful=!0,t}])}();
var core=new function(){this.version="1.0",this.app="cloudframework",this.debug=!1,this.request=new function(){this.token="",this.key="",this.headers={},this.get=function(e,t,o,n){if("undefined"!=typeof t&&null!=t){var r=t.split(".");t=window[r[0]];for(var i=1,a=r.length;i<a;i++)t=t[r[i]]}if("undefined"!=typeof o&&null!=o){var r=o.split(".");o=window[r[0]];for(var i=1,a=r.length;i<a;i++)o=o[r[i]]}var s="json";"undefined"!=typeof n&&"data"!=n&&(s=n),"undefined"!=typeof core.request.token&&""!=core.request.token&&(core.request.headers["X-DS-TOKEN"]=core.request.token),"undefined"!=typeof core.request.key&&""!=core.request.key&&(core.request.headers["X-WEB-KEY"]=core.request.key),$.ajax({type:"GET",url:e,headers:core.request.headers,dataType:s,async:!0,success:function(o){"json"!=s||1==o.success&&void 0!=typeof o.data?"undefined"!=typeof t&&null!=t&&t("undefined"!=typeof n&&"data"==n?o.data:o):(console.log("core.request.get(), Missing response.success==true or missing response.data Calling: "+e),console.log(o))},error:function(t){console.log("core.request.get_json_data(), error calling "+e),"undefined"!=typeof o&&null!=o&&o(t)}})},this.get_json_data=function(e,t,o){core.request.get(e,t,o,"data")}},this.template=new function(){this.templates=[],this.renderFromTemplate=function(e,t,o,n){return"undefined"==typeof core.template.templates[e]?(core.template.templates[e]="..loading",$("#"+n).html("..loading"),endpoint="/"+core.app+"/templates/"+e+".htm",$.ajax({type:"GET",url:endpoint,success:function(r){core.template.templates[e]=r,Mustache.parse(core.template.templates[e]),core.template.render(r,t,o,n)},error:function(){core.template.templates[e]="error loading template",alert("template does not exist: "+endpoint)}}),null):"..loading"==core.template.templates[e]?"..waiting"==$("#"+n).html()?void console.log("second call"):($("#"+n).html("..waiting"),window.setTimeout(core.template.renderFromTemplate,100,e,t,o,n),null):(core.template.render(core.template.templates[e],t,o,n),null)},this.renderFromScript=function(e,t,o,n){var r=$("#"+e).html();"undefined"==typeof r?console.log("Error trying to read as HTML template id: "+e):core.template.render(r,t,o,n)},this.render=function(e,t,o,n){if("html"==o){var r=Mustache.render(e,t);core.debug&&console.log(r),$("#"+n).html(r),pageSetUp()}}},this.cache=new function(){this.isAvailable=!0,"undefined"==typeof Storage&&(console.log("Cache is not supported in this browser"),this.available=!1),this.set=function(e,t){core.cache.isAvailable&&localStorage.setItem(e,t)},this.get=function(e,t){core.cache.isAvailable&&localStorage.getItem(e)},this.delete=function(e){core.cache.isAvailable&&localStorage.removeItem(e)}},this.cookies=new function(){this.path={path:"/"},this.remove=function(e){"undefined"!=typeof e&&($.removeCookie(e,core.cookies.path),core.debug&&console.log("removed cookie "+e))},this.set=function(e,t){$.cookie(e,t,core.cookies.path),core.debug&&console.log("set cookie "+e)},this.get=function(e){return $.cookie(e)}},this.params=function(e){var t=window.location.pathname.split("/");return t[e]},this.formParams=function(e){var t=new RegExp("[?&]"+e+"=([^&#]*)").exec(window.location.href);return null==t?(t=new RegExp("[?&]("+e+")[&#$]*").exec(window.location.href),null!=t||null):t[1]||0}};
/*!
...
"use strict";"undefined"!=typeof module&&"undefined"!=typeof exports&&module.exports===exports&&(module.exports="ngParallax"),angular.module("ngParallax",[]),angular.module("ngParallax").directive("ngParallax",["$timeout",function(e,t){return{restrict:"AE",scope:{pattern:"=",speed:"="},link:function(e,t,n){function o(){var t=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop,n=t/e.speed;i&&(n=.1*n),0==n?a.style.backgroundPosition="0% 0%":a.style.backgroundPosition="0% "+n+"%"}window.mobileAndTabletcheck=function(){return!!(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/Windows Phone/i))};var a=t[0];a.style.backgroundRepeat="repeat",a.style.backgroundAttachment="fixed",a.style.height="100%",a.style.margin="0 auto",a.style.position="relative",a.style.background="url("+e.pattern+")",a.style.backgroundAttachment="fixed";var i=window.mobileAndTabletcheck();window.document.addEventListener("touchmove",function(){o()}),window.document.addEventListener("scroll",function(){o()}),o()}}}]);
/**
 * Owl Carousel v2.2.0
...
"use strict";function setItemsResized(e){if(e.matches)for(var i in mq)mq[i].size==e.media&&(items=mq[i].items);else items--;owl.trigger("destroy.owl.carousel"),owl.owlCarousel({items:items,loop:!0,autoplay:!0})}function setItems(e){var i=2;return window.matchMedia(e.lg.size).matches?i=e.lg.items:window.matchMedia(e.md.size).matches?i=e.md.items:window.matchMedia(e.sm.size).matches?i=e.sm.items:window.matchMedia(e.xs.size).matches&&(i=e.xs.items),i}var mq={xs:{size:"(min-width: 480px)",items:3},sm:{size:"(min-width: 768px)",items:4},md:{size:"(min-width: 992px)",items:5},lg:{size:"(min-width: 1200px)",items:6}},owl=$(".owl-carousel");if(window.matchMedia){var items=setItems(mq);owl.owlCarousel({items:items,margin:owl.data("margin"),loop:!0,autoplay:!0});for(var query in mq)window.matchMedia(mq[query].size).addListener(setItemsResized)}
/*!
...
!function(){function e(e,s){return{restrict:"E",scope:{xxs:"=carouselXxs",xs:"=carouselXs",sm:"=carouselSm",md:"=carouselMd",lg:"=carouselLg",addClass:"@carouselClass"},link:function(e,s,c){}}}var s=s||angular.module("inView",["matchMedia"]);s.directive("carousel",e),e.$inject=["$log","screenSize"]}();
!function(){function e(e,c){return{restrict:"A",scope:{xxs:"=carouselXxs",xs:"=carouselXs",sm:"=carouselSm",md:"=carouselMd",lg:"=carouselLg"},link:function(e,c,r){}}}var c=c||angular.module("inView",["matchMedia"]);c.directive("carousel",e),e.$inject=["$log","screenSize"]}();
!function(){function e(e,o){return{restrict:"E",replace:!0,templateUrl:"/static/html/cookies.html",link:function(e,t,c){var i=o.get("cookiesAccepted");e.showCookies=!i,e.acceptCookies=function(){var e=new Date;e.setYear(e.getFullYear()+1),o.put("cookiesAccepted",1,{expires:e}),t.addClass("accepted")}}}}var o=o||angular.module("bloomCookies",["ngCookies"]);o.directive("cookies",e),e.$inject=["$log","$cookies"]}();
!function(){function i(i,e,n){return{restrict:"A",scope:{offset:"=bbInviewOffset",delay:"=bbInviewDelay",class:"@bbInviewClass"},link:function(i,t,s){var l,a=angular.element(n),c=i.offset||0,f=i.delay||0,o=i.class||"",d=!1;i.inView=a[0].pageYOffset+a[0].innerHeight>=t.offset().top+t[0].clientHeight/2+c,t.css("visibility","hidden"),i.init=function(){!d&&i.inView&&(d=!0,f>0?l=e(function(){t.css("visibility","visible").addClass("animated "+o)},f):t.css("visibility","visible").addClass("animated "+o))},i.init(),a.bind("scroll",function(){i.inView=a[0].pageYOffset+a[0].innerHeight>=t.offset().top+t[0].clientHeight/2+c,i.init()}),i.$on("$destroy",function(){e.cancel(l)})}}}var e=e||angular.module("inView",[]);e.directive("bbInview",i),i.$inject=["$log","$timeout","$window"]}();
!function(){function n(n,e,t,a){return{restrict:"A",scope:{lang:"@setLang"},link:function(n,a,g){n.lang==t.get("lang")&&(document.getElementById("current-lang").innerHTML=n.lang,a.addClass("active")),a.on("click tap",function(){t.put("lang",n.lang),e.find(".language-switch-dropdown a.active").removeClass("active"),a.addClass("active"),document.getElementById("current-lang").innerHTML=n.lang})}}}function e(n){return vm=this,vm.lang=n.get("lang")?n.get("lang"):"en",vm.get=function(){return vm.lang},vm.set=function(e){return n.put("lang",e)},{get:vm.get,set:vm.set}}var t=t||angular.module("bloomLang",["ngCookies","ngResource"]);t.directive("setLang",n),t.service("lang",e),n.$inject=["$log","$document","$cookies","$resource","$location"],e.$inject=["$cookies"]}();
!function(){function t(t){return{restrict:"A",link:function(t,e,a){function r(t,e,a){t.addEventListener?t.addEventListener(e,function(t){a(t,t.target)},!1):t.attachEvent&&t.attachEvent("on"+e,function(t){a(t,t.srcElement)})}function i(t){return!(t.getAttribute("readonly")||t.readonly)&&!(t.getAttribute("disabled")||t.disabled)&&(t.getAttribute("pattern")||t.getAttribute("required"))}function n(t){if(i(t)){var e=t.getAttribute("required")&&!t.value||t.getAttribute("pattern")&&t.value&&!new RegExp(t.getAttribute("pattern")).test(t.value);!e&&t.getAttribute("aria-invalid")?t.removeAttribute("aria-invalid"):e&&!t.getAttribute("aria-invalid")&&t.setAttribute("aria-invalid","true")}}e.click(t.showLogin),t.showLogin=function(){$("#loginModal").modal("show");var t=$(".input-block");t.each(function(e,a){var r=$(a),i=$("label",r),n=$("input",r),o=$(".input-info",r);n.attr("disabled")&&t.addClass("disabled"),n.on("focus",function(){r.addClass("dirty")}),n.on("blur input",function(){r.removeClass("has-error"),n.attr("required")&&!n.val()?(r.addClass("has-error"),o.html("<p>This field cannot be empty</p>")):"email"===n.attr("type")?n.attr("aria-invalid")?(r.addClass("has-error"),o.html("<p>Invalid email format</p>")):n.val().length>255&&(r.addClass("has-error"),o.html("<p>Maximum number of characters for this field is  255</p>")):"password"===n.attr("type")&&n.val().length<8&&(r.addClass("has-error"),o.html("<p>Password is too short (minimum is 8 characters)</p>"))}),void 0!=n.attr("placeholder")&&i.addClass("placeholder")})},r(document,"change",function(t,e){n(e)});for(var o=[document.getElementsByTagName("input"),document.getElementsByTagName("textarea")],l=o.length,d=0;d<l;d++)for(var s=o[d].length,u=0;u<s;u++)r(o[d][u],"change",function(t,e){n(e)})}}}var e=e||angular.module("bloomLogin",[]);e.directive("showLoginModal",t),t.$inject=["$log"]}();
!function(){function e(e,i,t,n,l){return{restrict:"A",link:function(e,d,c){var r=200,o=!1,h=d.find(".portfolio--item");n.rules={phone:"(max-width: 480px)",xs:"(min-width: 481px) and (max-width: 767px)",sm:"(min-width: 768px) and (max-width: 991px)"},e.rtime=new Date,e.cell={},e.grid={},e.setItems=function(){var i=0,c=0,r=0,o=0;e.documentWidth=t[0].documentElement.clientWidth,e.grid.cols=n.is("phone")?1:n.is("xs")?2:n.is("sm")?3:4;var s=e.cell.width||e.documentWidth/e.grid.cols,a=e.cell.height||angular.element(h[0])[0].clientHeight;e.grid.rows=Math.ceil(h.length/e.grid.cols),e.cell.width=e.documentWidth/e.grid.cols,e.cell.height=a*(e.cell.width/s),e.grid.height=e.grid.rows*e.cell.height,d.css("height",e.grid.height),angular.forEach(h,function(t,n){var d=angular.element(t),h=n%e.grid.cols;c+=0!=n&&0==h?1:0,d.css({position:"absolute",width:e.cell.width+"px"}),o=e.cell.width*h,r=c*e.cell.height,function(e,i,t){l(function(){e.css({left:i,top:t})},100)}(d,o,r),i++,i=n%e.grid.cols==0?0:i})},e.resizeEnd=function(){new Date-e.rtime<r?l(e.resizeEnd,r):(o=!1,e.setItems())},angular.element(i).bind("resize",function(){e.rtime=new Date,o===!1&&(o=!0,l(e.resizeEnd,r))})}}}var i=i||angular.module("bbGrid",["matchMedia"]);i.directive("portfolioGrid",e),e.$inject=["$log","$window","$document","screenSize","$timeout"]}();
!function(){function n(n,e){return{restrict:"A",scope:{target:"@sideMenuOpen"},link:function(n,t,o){function i(){0===n.backdrop.length&&e.find("body").append("<div class='aside-backdrop'></div>"),n.aside.addClass("in"),n.backdrop.addClass("in"),n.backdrop.on("click tap",a),e.find("[data-dismiss=aside], [data-dismiss=asidebar]").on("click tap",a)}function a(){e.find(".aside-backdrop.in").length>0&&n.backdrop.removeClass("in"),n.aside.removeClass("in")}n.aside=e.find(n.target),n.backdrop=e.find(".aside-backdrop"),t.on("click tap",i)}}}function e(n,e,t){return{restrict:"A",scope:{target:"@bbPopup",showClass:"@popupShow",hideClass:"@popupHide"},link:function(n,o,i){function a(){0===n.backdrop.length&&(e.find(".content").append("<div class='popup-backdrop'></div>"),n.backdrop=e.find(".popup-backdrop")),o.addClass("clicked"),n.popup.removeClass("hide"),n.popup.removeClass("fadeOutUp"),n.popup.addClass("opened "+n.showClass),n.backdrop.addClass("in"),n.backdrop.on("click tap",s)}function s(){e.find(".popup-backdrop.in").length>0&&n.backdrop.removeClass("in"),o.removeClass("clicked"),n.popup.removeClass("opened "+n.showClass),n.popup.addClass("fadeOutUp"),t(function(){n.popup.addClass("hide")},1e3)}n.popup=e.find(n.target),n.backdrop=e.find(".popup-backdrop"),o.on("click tap",a)}}}function t(n,e,t){return{restrict:"A",link:function(n,o,i){function a(n,e,t){function o(){a+=1/60;var e=a/s,c=r[t](e);e<1?(requestAnimFrame(o),window.scrollTo(0,i+(n-i)*c)):window.scrollTo(0,n)}var i=window.scrollY,n=n||0,e=e||2e3,t=t||"easeOutSine",a=0,s=Math.max(.1,Math.min(Math.abs(i-n)/e,.8)),r=(Math.PI/2,{easeOutSine:function(n){return Math.sin(n*(Math.PI/2))},easeInOutSine:function(n){return-.5*(Math.cos(Math.PI*n)-1)},easeInOutQuint:function(n){return(n/=.5)<1?.5*Math.pow(n,5):.5*(Math.pow(n-2,5)+2)}});o()}t.rules={desktop:"(min-width: 1024px)"},e.ready(function(){var i=o.offset(),s=o[0].clientHeight,r=o.parent().offset().top,c=o.parent()[0].clientHeight,d=e.find(".nav-top")[0].clientHeight;n.vh=.09*document.documentElement.clientHeight,n.desktop=t.is("desktop"),t.on("desktop",function(e){n.desktop=e,n.vh=.09*document.documentElement.clientHeight}),e.scroll(function(){var t=e.scrollTop(),a=t+s+d;if(t>i.top-d&&n.desktop){var u=a<r+c?t-i.top+d:c-s-2;o.css({marginTop:u})}else o.css({marginTop:0})});var u=e.find(".plus-bullet");u.on("click tap",function(){o.toggleClass("sticky-show")}),o.find("a").on("click tap",function(t){t.preventDefault();var i=angular.element(t.target).attr("href");a(e.find(i)[0].offsetTop+2*n.vh,1500),n.desktop||o.toggleClass("sticky-show")})}),window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(n){window.setTimeout(n,1e3/60)}}()}}}var o=o||angular.module("bloomSideMenu",["matchMedia"]);o.directive("sideMenuOpen",n),o.directive("bbPopup",e),o.directive("sticky",t),n.$inject=["$log","$document"],e.$inject=["$log","$document","$timeout"],t.$inject=["$log","$document","screenSize"],o.directive("smoothScroll",["$log","$document",function(n,e){return{restrict:"A",scope:{container:"@scrollContainer",duration:"=scrollDuration"},link:function(n,t,o){function i(n,e,t){function o(){a+=1/60;var e=a/s,c=r[t](e);e<1?(requestAnimFrame(o),window.scrollTo(0,i+(n-i)*c)):window.scrollTo(0,n)}var i=window.scrollY,n=n||0,e=e||2e3,t=t||"easeOutSine",a=0,s=Math.max(.1,Math.min(Math.abs(i-n)/e,.8)),r=(Math.PI/2,{easeOutSine:function(n){return Math.sin(n*(Math.PI/2))},easeInOutSine:function(n){return-.5*(Math.cos(Math.PI*n)-1)},easeInOutQuint:function(n){return(n/=.5)<1?.5*Math.pow(n,5):.5*(Math.pow(n-2,5)+2)}});o()}var a=n.duration||1500;n.container||"body";n.vh=.09*document.documentElement.clientHeight,t.find("a").on("click tap",function(t){t.preventDefault();var o=angular.element(t.target).attr("href"),s="#body"==o?0:2*n.vh;i(e.find(o)[0].offsetTop+s,a)}),window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(n){window.setTimeout(n,1e3/60)}}()}}}])}();
!function(){function t(t){function e(t,e,a){e.addClass(t.name),t.theme&&e.addClass("tabs__"+t.theme),t.width=e[0].clientWidth,t.tabs={all:e.find('[role="tab"]'),content:e.find("[tab-name]"),names:[],seller:e.find('[tab-name="seller"]'),buyer:e.find('[tab-name="buyer"]')};for(var s=0,n=t.tabs.content.length;s<n;s++){var i=t.tabs.content[s].attributes["tab-name"].value;t.tabs.names.push(i)}t.gap=30,t.seller=!0,t.activeTab=t.active||"seller",t.setActive=function(a){t.width=e[0].clientWidth,t.tabs.all.removeClass("active"),t.tabs.content.removeClass("active"),e.find('[tab-open="'+a+'"]').addClass("active"),"seller"===a?(t.tabs.seller.css({transform:"translateX(0)"}),t.tabs.buyer.css({transform:"translateX("+t.gap+"px)"})):(t.tabs.seller.css({transform:"translateX(-"+(t.width+t.gap)+"px)"}),t.tabs.buyer.css({transform:"translateX(-"+t.width+"px)"}))},t.clickTab=function(e){var a,s=angular.element(e.target);a=void 0==s[0].attributes["tab-open"]?s[0].parentNode.attributes["tab-open"].nodeValue:s[0].attributes["tab-open"].value,t.seller="seller"===a,t.setActive(a)},t.switchTab=function(){var a=e.find('[role="tab"].active');void 0==a[0].attributes["tab-open"]?t.activeTabName=a[0].parentNode.attributes["tab-open"].nodeValue:t.activeTabName=a[0].attributes["tab-open"].value;var s="seller"==t.activeTabName?"buyer":"seller";return t.setActive(s),s},t.tabs.all.on("click tap",function(e){t.clickTab(e)}),t.switcher&&(t.switchElement=angular.element(t.switcher),t.switchElement.find("[data-text]").addClass("hidden"),t.switchElement.find('[data-text="'+t.activeTab+'"]').removeClass("hidden"),t.switchElement.on("click tap",function(){var e=t.switchTab();t.switchElement.find('[data-text="'+e+'"]').removeClass("hidden"),t.switchElement.find('[data-text="'+t.activeTabName+'"]').addClass("hidden")})),t.setActive(t.activeTab)}return{restrict:"A",scope:{theme:"@tabsTheme",type:"@tabsType",name:"@tabs",active:"@tabsActive",switcher:"@tabsSwitcher"},link:e}}var e=e||angular.module("bloomTabs",["ngAnimate"]);e.directive("tabs",t),t.$inject=["$log"]}();
!function(){function e(){return{restrict:"A",require:"ngModel",link:function(e,i,n,t){t.$parsers.unshift(function(e){return t.$setValidity("fullName",e.split(" ").length>1),e})}}}function i(){return{restrict:"A",scope:{passwordCheck:"="},require:"ngModel",link:function(e,i,n,t){t.$parsers.unshift(function(i){var n=i===e.passwordCheck;return t.$setValidity("passwordCheck",n),i})}}}function n(e,i){return{restrict:"A",require:"ngModel",link:function(n,t,r,s){i(function(){e.find("div[ng-messages]").removeClass("hidden")}),s.$parsers.unshift(function(e){var i=/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(e);return s.$setValidity("emailCheck",i),e})}}}var t=t||angular.module("bloomValidate",["ngAnimate","ngMessages"]);t.directive("validateName",e),t.directive("passwordCheck",i),t.directive("validateEmail",n),n.$inject=["$document","$timeout"]}();
function MainController(o){}var app=app||angular.module("Bloombees",["ngCookies","ngAnimate","bloomValidate","bloomSideMenu","bloomCookies","bloomLang","bloomTabs","ngParallax","bbGrid","inView"]);app.controller("MainController",MainController),MainController.$inject=["$log"];
$(function(){var a=$(".bb-input");a.each(function(d,t){var i=$(t),l=$("label",i),n=$("input, textarea",i);$(".input-info",i);n.attr("disabled")&&a.addClass("disabled"),n.on("focus",function(){i.addClass("dirty")}),void 0!=n.attr("placeholder")&&l.addClass("placeholder")})});
"use strict";function forgotPassword(){$("#login").hide(),$("#forgot").removeClass("hidden").fadeIn(300)}function backLogin(){$("#login").fadeIn(300),$("#forgot").hide()}function showLogin(){$("#forgot").hide(),$("#loginModal").modal("show"),$("#login").fadeIn(500)}
function error(e){console.log(e)}function assignHash(e){core.cookies.set("bbhash",e)}function assignToken(e){core.cookies.set("bbtoken",e)}core.request.key="Developer",core.debug=!0,core.formParams("_deleteCookies")&&(core.cookies.remove("bbhash"),core.cookies.remove("bbtoken")),"undefined"==typeof core.cookies.get("bbhash")&&core.request.get_json_data("https://bloombees.com/h/api/auth/hash","assignHash","error");