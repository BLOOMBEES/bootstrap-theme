...
!function(){function e(e,i,t,n,l){return{restrict:"A",link:function(d,c,o){var r=200,s=c.find(".portfolio--item"),h=!1;n.rules={phone:"(max-width: 480px)",xs:"(min-width: 481px) and (max-width: 767px)",sm:"(min-width: 768px) and (max-width: 991px)"},d.rtime=new Date,d.cell={},d.grid={},d.setItems=function(){var i=0,o=0,r=0,h=0;e.log(n.is("phone"),n.is("xs")),d.documentWidth=t[0].documentElement.clientWidth,d.grid.cols=n.is("phone")?1:n.is("xs")?2:n.is("sm")?3:4;var g=d.cell.width||d.documentWidth/d.grid.cols,a=d.cell.height||angular.element(s[0])[0].clientHeight;e.log(d.grid.cols),d.grid.rows=Math.ceil(s.length/d.grid.cols),d.cell.width=d.documentWidth/d.grid.cols,d.cell.height=a*(d.cell.width/g),d.grid.height=d.grid.rows*d.cell.height,c.css("height",d.grid.height),angular.forEach(s,function(e,t){var n=angular.element(e),c=t%d.grid.cols;o+=0!=t&&0==c?1:0,n.css({position:"absolute",width:d.cell.width+"px"}),h=d.cell.width*c,r=o*d.cell.height,function(e,i,t){l(function(){e.css({left:i,top:t})},100)}(n,h,r),i++,i=t%d.grid.cols==0?0:i})},d.resizeEnd=function(){new Date-d.rtime<r?l(d.resizeEnd,r):(h=!1,d.setItems())},angular.element(i).bind("resize",function(){d.rtime=new Date,h===!1&&(h=!0,l(d.resizeEnd,r))}),d.setItems()}}}var i=i||angular.module("bbGrid",["matchMedia"]);i.directive("portfolioGrid",e),e.$inject=["$log","$window","$document","screenSize","$timeout"]}();
!function(){function n(n,t){return{restrict:"A",scope:{target:"=sideMenuOpen"},link:function(n,e,i){function o(){0===n.backdrop.length&&t.find("body").append("<div class='aside-backdrop'></div>"),n.aside.addClass("in"),n.backdrop.addClass("in"),n.backdrop.on("click tap",a),t.find("[data-dismiss=aside], [data-dismiss=asidebar]").on("click tap",a)}function a(){t.find(".aside-backdrop.in").length>0&&n.backdrop.removeClass("in"),n.aside.removeClass("in")}n.aside=t.find("#"+n.target),n.backdrop=t.find(".aside-backdrop"),e.on("click tap",o)}}}var t=t||angular.module("bloomSideMenu",["matchMedia"]);t.directive("sideMenuOpen",n),n.$inject=["$log","$document"],t.directive("sticky",["$log","$document","screenSize",function(n,t,e){return{restrict:"A",link:function(n,i,o){function a(n,t,e){function i(){a+=1/60;var t=a/r,c=s[e](t);t<1?(requestAnimFrame(i),window.scrollTo(0,o+(n-o)*c)):window.scrollTo(0,n)}var o=window.scrollY,n=n||0,t=t||2e3,e=e||"easeOutSine",a=0,r=Math.max(.1,Math.min(Math.abs(o-n)/t,.8)),s=(Math.PI/2,{easeOutSine:function(n){return Math.sin(n*(Math.PI/2))},easeInOutSine:function(n){return-.5*(Math.cos(Math.PI*n)-1)},easeInOutQuint:function(n){return(n/=.5)<1?.5*Math.pow(n,5):.5*(Math.pow(n-2,5)+2)}});i()}e.rules={desktop:"(min-width: 1024px)"},t.ready(function(){var o=i.offset(),r=i[0].clientHeight,s=i.parent().offset().top,c=i.parent()[0].clientHeight,u=t.find(".nav-top")[0].clientHeight;n.vh=.09*document.documentElement.clientHeight,n.desktop=e.is("desktop"),e.on("desktop",function(t){n.desktop=t,n.vh=.09*document.documentElement.clientHeight}),t.scroll(function(){var e=t.scrollTop(),a=e+r+u;if(e>o.top-u&&n.desktop){var d=a<s+c?e-o.top+u:c-r-2;i.css({marginTop:d})}else i.css({marginTop:0})});var d=t.find(".plus-bullet");d.on("click tap",function(){i.toggleClass("sticky-show")}),i.find("a").on("click tap",function(e){e.preventDefault();var o=angular.element(e.target).attr("href");a(t.find(o)[0].offsetTop+2*n.vh,1500),n.desktop||i.toggleClass("sticky-show")})}),window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(n){window.setTimeout(n,1e3/60)}}()}}}]),t.directive("smoothScroll",["$log","$document",function(n,t){return{restrict:"A",scope:{container:"@scrollContainer",duration:"=scrollDuration"},link:function(e,i,o){function a(n,t,e){function i(){a+=1/60;var t=a/r,c=s[e](t);t<1?(requestAnimFrame(i),window.scrollTo(0,o+(n-o)*c)):window.scrollTo(0,n)}var o=window.scrollY,n=n||0,t=t||2e3,e=e||"easeOutSine",a=0,r=Math.max(.1,Math.min(Math.abs(o-n)/t,.8)),s=(Math.PI/2,{easeOutSine:function(n){return Math.sin(n*(Math.PI/2))},easeInOutSine:function(n){return-.5*(Math.cos(Math.PI*n)-1)},easeInOutQuint:function(n){return(n/=.5)<1?.5*Math.pow(n,5):.5*(Math.pow(n-2,5)+2)}});i()}var r=e.duration||1500;e.container||"body";e.vh=.09*document.documentElement.clientHeight,i.find("a").on("click tap",function(i){i.preventDefault();var o=angular.element(i.target).attr("href");n.log(o,r),a(t.find(o)[0].offsetTop+2*e.vh,r)}),window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(n){window.setTimeout(n,1e3/60)}}()}}}])}();
!function(){function e(e){function t(e,t,a){"dark"===e.theme&&t.addClass("tabs__dark"),e.width=t[0].clientWidth,e.tabs={all:t.find('[role="tab"]'),seller:t.find('[tab-name="seller"]'),buyer:t.find('[tab-name="buyer"]')},e.gap=30,e.seller=!0,e.setActive=function(a){e.tabs.all.removeClass("active"),t.find('[tab-open="'+a+'"]').addClass("active"),"seller"===a?(e.tabs.seller.css({transform:"translateX(0)"}),e.tabs.buyer.css({transform:"translateX("+e.gap+"px)"})):(e.tabs.seller.css({transform:"translateX(-"+(e.width+e.gap)+"px)"}),e.tabs.buyer.css({transform:"translateX(-"+e.width+"px)"}))},e.tabs.all.on("click tap",function(t){var a=angular.element(t.target),s=a[0].attributes["tab-open"].value;e.seller="seller"===s,e.setActive(s)}),e.setActive("seller")}return{restrict:"A",scope:{theme:"@tabsTheme"},link:t}}var t=t||angular.module("bloomTabs",["ngAnimate"]);t.directive("tabs",e),e.$inject=["$log"]}();
