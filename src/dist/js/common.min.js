...
!function(){function n(n,e){return{restrict:"A",scope:{target:"@sideMenuOpen"},link:function(n,t,o){function i(){0===n.backdrop.length&&e.find("body").append("<div class='aside-backdrop'></div>"),n.aside.addClass("in"),n.backdrop.addClass("in"),n.backdrop.on("click tap",a),e.find("[data-dismiss=aside], [data-dismiss=asidebar]").on("click tap",a)}function a(){e.find(".aside-backdrop.in").length>0&&n.backdrop.removeClass("in"),n.aside.removeClass("in")}n.aside=e.find(n.target),n.backdrop=e.find(".aside-backdrop"),t.on("click tap",i)}}}function e(n,e,t){return{restrict:"A",scope:{target:"@bbPopup",showClass:"@popupShow",hideClass:"@popupHide"},link:function(o,i,a){function s(){0===o.backdrop.length&&(e.find(".content").append("<div class='popup-backdrop'></div>"),o.backdrop=e.find(".popup-backdrop")),i.addClass("clicked"),o.popup.removeClass("hide"),o.popup.removeClass("fadeOutUp"),o.popup.addClass("opened "+o.showClass),o.backdrop.addClass("in"),o.backdrop.on("click tap",r)}function r(){e.find(".popup-backdrop.in").length>0&&o.backdrop.removeClass("in"),i.removeClass("clicked"),o.popup.removeClass("opened "+o.showClass),o.popup.addClass("fadeOutUp"),t(function(){o.popup.addClass("hide")},1e3)}o.popup=e.find(o.target),n.log(o.target,o.popup),o.backdrop=e.find(".popup-backdrop"),i.on("click tap",s)}}}function t(n,e,t){return{restrict:"A",link:function(n,o,i){function a(n,e,t){function o(){a+=1/60;var e=a/s,c=r[t](e);e<1?(requestAnimFrame(o),window.scrollTo(0,i+(n-i)*c)):window.scrollTo(0,n)}var i=window.scrollY,n=n||0,e=e||2e3,t=t||"easeOutSine",a=0,s=Math.max(.1,Math.min(Math.abs(i-n)/e,.8)),r=(Math.PI/2,{easeOutSine:function(n){return Math.sin(n*(Math.PI/2))},easeInOutSine:function(n){return-.5*(Math.cos(Math.PI*n)-1)},easeInOutQuint:function(n){return(n/=.5)<1?.5*Math.pow(n,5):.5*(Math.pow(n-2,5)+2)}});o()}t.rules={desktop:"(min-width: 1024px)"},e.ready(function(){var i=o.offset(),s=o[0].clientHeight,r=o.parent().offset().top,c=o.parent()[0].clientHeight,d=e.find(".nav-top")[0].clientHeight;n.vh=.09*document.documentElement.clientHeight,n.desktop=t.is("desktop"),t.on("desktop",function(e){n.desktop=e,n.vh=.09*document.documentElement.clientHeight}),e.scroll(function(){var t=e.scrollTop(),a=t+s+d;if(t>i.top-d&&n.desktop){var u=a<r+c?t-i.top+d:c-s-2;o.css({marginTop:u})}else o.css({marginTop:0})});var u=e.find(".plus-bullet");u.on("click tap",function(){o.toggleClass("sticky-show")}),o.find("a").on("click tap",function(t){t.preventDefault();var i=angular.element(t.target).attr("href");a(e.find(i)[0].offsetTop+2*n.vh,1500),n.desktop||o.toggleClass("sticky-show")})}),window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(n){window.setTimeout(n,1e3/60)}}()}}}var o=o||angular.module("bloomSideMenu",["matchMedia"]);o.directive("sideMenuOpen",n),o.directive("bbPopup",e),o.directive("sticky",t),n.$inject=["$log","$document"],e.$inject=["$log","$document","$timeout"],t.$inject=["$log","$document","screenSize"],o.directive("smoothScroll",["$log","$document",function(n,e){return{restrict:"A",scope:{container:"@scrollContainer",duration:"=scrollDuration"},link:function(n,t,o){function i(n,e,t){function o(){a+=1/60;var e=a/s,c=r[t](e);e<1?(requestAnimFrame(o),window.scrollTo(0,i+(n-i)*c)):window.scrollTo(0,n)}var i=window.scrollY,n=n||0,e=e||2e3,t=t||"easeOutSine",a=0,s=Math.max(.1,Math.min(Math.abs(i-n)/e,.8)),r=(Math.PI/2,{easeOutSine:function(n){return Math.sin(n*(Math.PI/2))},easeInOutSine:function(n){return-.5*(Math.cos(Math.PI*n)-1)},easeInOutQuint:function(n){return(n/=.5)<1?.5*Math.pow(n,5):.5*(Math.pow(n-2,5)+2)}});o()}var a=n.duration||1500;n.container||"body";n.vh=.09*document.documentElement.clientHeight,t.find("a").on("click tap",function(t){t.preventDefault();var o=angular.element(t.target).attr("href"),s="#body"==o?0:2*n.vh;i(e.find(o)[0].offsetTop+s,a)}),window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(n){window.setTimeout(n,1e3/60)}}()}}}])}();
!function(){function t(t){function e(e,a,s){a.addClass(e.name),e.theme&&a.addClass("tabs__"+e.theme),e.width=a[0].clientWidth,e.tabs={all:a.find('[role="tab"]'),content:a.find("[tab-name]"),seller:a.find('[tab-name="seller"]'),buyer:a.find('[tab-name="buyer"]')},e.gap=30,e.seller=!0,e.activeTab=e.active||"seller",e.setActive=function(t){e.width=a[0].clientWidth,e.tabs.all.removeClass("active"),e.tabs.content.removeClass("active"),a.find('[tab-open="'+t+'"]').addClass("active"),"seller"===t?(e.tabs.seller.css({transform:"translateX(0)"}),e.tabs.buyer.css({transform:"translateX("+e.gap+"px)"})):(e.tabs.seller.css({transform:"translateX(-"+(e.width+e.gap)+"px)"}),e.tabs.buyer.css({transform:"translateX(-"+e.width+"px)"}))},e.clickTab=function(t){var a,s=angular.element(t.target);a=void 0==s[0].attributes["tab-open"]?s[0].parentNode.attributes["tab-open"].nodeValue:s[0].attributes["tab-open"].value,e.seller="seller"===a,e.setActive(a)},e.switchTab=function(){e.tabs.all.hasClass("active")&&t.log(e.tabs.all[0])},e.tabs.all.on("click tap",function(t){e.clickTab(t)}),e.switcher&&e.switcher.on("click tap",function(){e.switchTab()}),e.setActive(e.activeTab)}return{restrict:"A",scope:{theme:"@tabsTheme",type:"@tabsType",name:"@tabs",active:"@tabsActive",switcher:"@tabsSwitcher"},link:e}}var e=e||angular.module("bloomTabs",["ngAnimate"]);e.directive("tabs",t),t.$inject=["$log"]}();
