...
$(function(){$.fn.hasAttr=function(t){var e=this.attr(t);return void 0!==e&&e!==!1},$(document).on("click",function(t){0===$(t.target).closest(".bb-native-select").length&&$(".bb-native-select > input").prop("checked",!1)}),$(".bb-native-select > input").on("change",function(){var t=$(this).attr("id");$(".bb-native-select > input").each(function(){t!=$(this).attr("id")&&$(this).prop("checked",!1)})}),$(".bb-native-select ul input").on("change",function(){var t=$(this).closest(".bb-native-select"),e=t.children("label").children("span"),n=$(this).next("label");e.text(n.text()),t.children("input").prop("checked",!1),t.addClass("filled")}),$.fn.bbSelect=function(){return $(this).find(".radio").find("input[type=radio]:checked").val()}});
