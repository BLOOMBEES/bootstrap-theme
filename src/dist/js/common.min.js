...
$(function(){$.fn.hasAttr=function(e){var t=this.attr(e);return void 0!==t&&t!==!1},$(document).on("click",function(t){0===$(t.target).closest(".bb-native-select").length&&($(".bb-native-select > input").prop("checked",!1),$(".bb-native-select").removeClass("active"),e=null)});var e=null,t=0;$(document).keydown(function(i){if(1===$(".bb-native-select.active").length){var l=$(".bb-native-select.active").find(".radio"),n=l.find("li");if(38===i.which||40===i.which||13===i.which)switch(i.preventDefault(),i.which){case 40:null===e?(e=l.find("li").first().find("label"),e.addClass("active")):1===e.closest("li").next().length&&(e.removeClass("active"),e=e.closest("li").next().find("label"),e.addClass("active"),t+=30,e.closest("ul").scrollTop(t));break;case 38:null===e?(e=l.find("li").first().find("label"),e.addClass("active")):1===e.closest("li").prev().length&&(e.removeClass("active"),e=e.closest("li").prev().find("label"),e.addClass("active"),t-=30,e.closest("ul").scrollTop(t));break;case 13:null!=e&&(e.closest("li").find("label").trigger("click"),e=null,t=0)}i.which>=65&&i.which<=90&&n.each(function(){if($(this).text().replace(/ /g,"").replace(/\s/g,"").toLowerCase().charAt(0)===i.key)return null!==e&&e.removeClass("active"),e=$(this).find("label"),e.addClass("active"),$(this).closest(".radio").scrollTop($(this).position().top),!1})}}),$(".bb-native-select > input").on("change",function(){var e=$(this).attr("id");$(".bb-native-select > input").each(function(){e!=$(this).attr("id")&&$(this).prop("checked",!1)})}),$(".bb-native-select").on("click",function(){$(this).addClass("active"),e=null,t=0}),$(".bb-native-select ul input").on("change",function(){var i=$(this).closest(".bb-native-select"),l=i.children("label").children("span"),n=$(this).next("label");l.text(n.text()),i.removeClass("active"),i.children("input").prop("checked",!1),i.addClass("filled"),e=null,t=0}),$.fn.bbSelect=function(){return $(this).find(".radio").find("input[type=radio]:checked").val()}});
...
void 0===BloombeesInterface.auth&&(BloombeesInterface.auth=new function(){var o=this;o.init=function(){BloombeesInterface.debug&&console.log("BloombeesInterface.auth.init()"),"#login"===window.location.hash&&o.showLogin(),BloombeesInterface.validateForm($("#loginForm")),BloombeesInterface.validateForm($("#forgotForm"))},o.showLogin=function(){"/discover/"===location.pathname?angular.element(document.body).injector().get("modalSrv").login():void 0===$("#loginModal")?BloombeesInterface.error('.auth.showlogin() missing dom.object["loginModal"]'):($("#forgot").hide(),$("#forgot-ok").hide(),$("#forgot-error").hide(),$("#signin-error").hide(),$("#loginModal").modal("show"),$("#login").fadeIn(500),$(".login-form-mode-only").removeClass("hidden").fadeIn(300),$(".signup-form-mode-only").addClass("hidden").fadeOut(300))},o.showSignup=function(){"/discover/"===location.pathname?angular.element(document.body).injector().get("modalSrv").signup():location.href="/register"},o.showForgotPassword=function(){"/discover/"===location.pathname?angular.element(document.body).injector().get("modalSrv").closeAll():($("#login").hide(),$("#forgot").removeClass("hidden").fadeIn(300),$("#forgot-ok").hide(),$("#forgot-error").hide())},o.backFromForgot=function(){"/discover/"===location.pathname?(angular.element(document.body).injector().get("modalSrv").closeAll(),angular.element(document.body).injector().get("modalSrv").login()):($("#login").fadeIn(300),$("#forgot").hide(),$("#forgot-ok").hide(),$("#forgot-error").hide())},o.signInWithUserPassword=function(){$("#loginModal").find(".loader-container").addClass("active"),Bloombees.signInWithUserPassword({email:$("#loginEmail").val(),password:$("#loginPassword").val()},function(e){return e.success?Core.user.get("Store_uniqueId")?void(location.href.search("/referral")!=-1?location.href="/referral?initSignUp":location.href.search("/register")!=-1&&(location.href="/private/dashboard")):location.href.search("/register")!=-1?void(location.href="/register?initSignUp"):location.href.search("/referral")!=-1?void(location.href="/referral?initSignUp"):void(location.href="/discover"):void o.displayError()})},o.signInViaOauth=function(e){var r=$("#loginModal").find(".loader-container");r.addClass("active"),Bloombees.signInWithOauthPopUp(e,Core.url.parts("origin")+"/oauth-confirmation?oauth_id={id}",function(e){if(e.success){if(!Core.user.get("Store_uniqueId"))return location.href.search("/register")!=-1?void(location.href="/register?initSignUp"):location.href.search("/referral")!=-1?void(location.href="/referral?initSignUp"):void(location.href="/discover");location.href.search("/referral")!=-1?location.href="/referral?initSignUp":location.href.search("/register")!=-1&&(location.href="/private/dashboard")}else o.displayError(),r.removeClass("animated zoomOut active error")})},o.forgotFormSubmit=function(){var o=$("#loginModal").find(".loader-container");return o.addClass("active"),Bloombees.generatePasswordRecovery($("#forgotEmail").val(),function(e){$("#forgot").hide(),e.success?$("#forgot-ok").show():$("#forgot-error").show(),o.removeClass("active")}),!1},o.displayError=function(o){$("#loginModal").find(".loader-container").removeClass("active"),$("#login").hide(),$("#signin-error").show()},o.backFromNotFound=function(){"/discover/"===location.pathname?(angular.element(document.body).injector().get("modalSrv").closeAll(),angular.element(document.body).injector().get("modalSrv").login()):($("#login").fadeIn(300),$("#forgot").hide(),$("#forgot-ok").hide(),$("#forgot-error").hide(),$("#signin-error").hide())}});
