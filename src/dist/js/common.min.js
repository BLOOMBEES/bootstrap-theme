...
!function(){function e(){return{restrict:"A",require:"ngModel",link:function(e,t,i,r){r.$parsers.unshift(function(e){return r.$setValidity("fullName",e.split(" ").length>1),e})}}}function t(){return{restrict:"A",scope:{passwordCheck:"="},require:"ngModel",link:function(e,t,i,r){r.$parsers.unshift(function(t){var i=t===e.passwordCheck;return r.$setValidity("passwordCheck",i),t})}}}function i(){return{restrict:"A",require:"ngModel",link:function(e,t,i,r){r.$parsers.unshift(function(e){var t=/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(e);return r.$setValidity("emailCheck",t),e})}}}var r=r||angular.module("bloomValidate",["ngAnimate","ngMessages"]);r.directive("validateName",e),r.directive("passwordCheck",t),r.directive("validateEmail",i)}();
