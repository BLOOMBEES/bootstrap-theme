...
!function(){function e(e,t,i,n,l){return{restrict:"A",link:function(c,s,o){n.rules={xxs:"(max-width: 480px)"},e.log(n.is("xxs"));var h=200,d=s.find(".portfolio--item"),r=!1,g=n.is("xxs")?1:n.is("xs")?2:n.is("sm")?3:4;c.rtime=new Date,c.documentWidth=i[0].documentElement.clientWidth,c.cell={width:c.documentWidth/g,height:angular.element(d[0])[0].clientHeight},c.grid={rows:Math.ceil(d.length/g),cols:g,height:Math.ceil(d.length/g)*c.cell.height},c.setItems=function(){var e=0,t=0,o=0,h=0,r=c.cell.width,g=c.cell.height;c.documentWidth=i[0].documentElement.clientWidth,c.grid.cols=n.is("xxs")?1:n.is("xs")?2:n.is("sm")?3:4,c.grid.rows=Math.ceil(d.length/c.grid.cols),c.cell.width=c.documentWidth/c.grid.cols,c.cell.height=g*(c.cell.width/r),c.grid.height=c.grid.rows*c.cell.height,s.css("height",c.grid.height);c.cell.width-r,c.cell.height-g;console.time("test"),angular.forEach(d,function(i,n){var s=angular.element(i),d=n%c.grid.cols;t+=0!=n&&0==d?1:0,s.css({position:"absolute",width:c.cell.width+"px"}),h=c.cell.width*d,o=t*c.cell.height,function(e,t,i){l(function(){e.css({left:t,top:i})},100),l(function(){},850)}(s,h,o),e++,e=n%c.grid.cols==0?0:e}),console.timeEnd("test")},c.resizeEnd=function(){new Date-c.rtime<h?l(c.resizeEnd,h):(r=!1,c.setItems())},angular.element(t).bind("resize",function(){c.rtime=new Date,r===!1&&(r=!0,l(c.resizeEnd,h))}),c.setItems(),c.$on("$destroy",function(){})}}}var t=t||angular.module("bbGrid",["matchMedia"]);t.directive("portfolioGrid",e),e.$inject=["$log","$window","$document","screenSize","$timeout"]}();
...
function MainController(o){}var app=app||angular.module("Bloombees",["ngCookies","ngAnimate","bloomValidate","bloomSideMenu","bloomCookies","bloomLang","bloomTabs","ngParallax","bbGrid","inView"]);app.controller("MainController",MainController),MainController.$inject=["$log","screenSize"];
